...
_This document is a living specification. As the Tokn project evolves, this specification should be updated to reflect the current state and future direction of the system._
