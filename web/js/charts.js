  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (providerCanvas) {
      barChart('provider-chart', [
        { label: 'OpenAI', value: 412.50 },
        { label: 'Anthropic', value: 267.00 },
        { label: 'Google', value: 104.00 },
    ...
    if (modelCanvas) {
      horizontalBar('model-chart', [
        { label: 'gpt-4o', value: 312.00 },
        { label: 'claude-3-5-sonnet', value: 174.00 },
        { label: 'claude-3-haiku', value: 87.00 },
        { label: 'gemini-1.5-pro', value: 76.00 },
